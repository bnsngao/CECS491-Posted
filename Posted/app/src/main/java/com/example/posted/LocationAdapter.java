...
import com.example.posted.LocationFragment.OnListFragmentInteractionListener;
...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.ViewHolder> {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListFragmentInteraction(holder.mItem.getLocationID());
                }
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mRating = view.findViewById(R.id.locationRatingBar);
            mImageView = view.findViewById(R.id.locationImage);
        }
